...
class __TwigTemplate_81cf16fcbe23daf41dcc1a0bdc6a22d26f54c3ae7618ec0c65aed9b0377397f7 extends Twig_Template
{
    ...
    <div class=\"entityList\">
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "dimensionCategories"));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["category"] => $context["dimensions"]) {
            // line 5
            echo "        ";
            $context["firstCategory"] = ($this->getAttribute($this->getContext($context, "loop"), "index0") == 0);
            // line 6
            echo "            <div class='dimensionCategory'>
                ";
            // line 7
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array($this->getContext($context, "category"))), "html", null, true);
            echo "
                <ul class='listCircle'>
                    ";
            // line 9
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "dimensions"));
            foreach ($context['_seq'] as $context["idx"] => $context["dimension"]) {
                // line 10
                echo "                        <li class=\"reportDimension ";
                if ((($this->getContext($context, "idx") == 0) && $this->getContext($context, "firstCategory"))) {
                    echo "activeDimension";
                }
                echo "\"
                            data-url=\"";
                // line 11
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "dimension"), "url"), "html", null, true);
                echo "\">
                            <span class='dimension'>";
                // line 12
                echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array($this->getAttribute($this->getContext($context, "dimension"), "title"))), "html", null, true);
                echo "</span>
                        </li>
                    ";
            }
    ...
    <div style=\"float:left;max-width:900px;\">
        ...
        // line 25
        echo $this->getContext($context, "firstReport");
        echo "</div>
    </div>
    <div class=\"clear\"></div>
