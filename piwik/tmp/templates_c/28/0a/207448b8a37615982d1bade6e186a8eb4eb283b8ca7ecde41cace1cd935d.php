...
class __TwigTemplate_280a207448b8a37615982d1bade6e186a8eb4eb283b8ca7ecde41cace1cd935d extends Twig_Template
{
...
<ul id='visitsLive'>
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["visitor"]) {
            ...
            // line 29
            echo "                ";
            if ($this->getAttribute($this->getContext($context, "visitor", true), "visitorId", array(), "any", true, true)) {
                // line 30
            ...
            <div class=\"referrer\">
                ";
            // line 40
            if (($this->getAttribute($this->getContext($context, "visitor"), "referrerType") != "direct")) {
                // line 41
                echo "                    ";
